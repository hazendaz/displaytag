 ...
 */
public class BasicELTableTagTest extends DisplaytagCase
{

    /**
     * logger.
     */
    private static Log log = LogFactory.getLog(BasicELTableTagTest.class);
     ...
     */
    public BasicELTableTagTest(String name)
    {
        super(name);
    }
    ...
    public void testAutoGeneratedColumns() throws Exception
    {
        ...
        WebRequest request = new GetMethodWebRequest("http://localhost/el/autocolumns.jsp");
