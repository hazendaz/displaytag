...
<p>
	A "decorator" is a design pattern where one object provides a layer of functionality by
...
<ul>
	<li>
		The Wrapper class must be a subclass of TableDecorator.  There is various
	...
	<li>
		Be smart and create your formatters just once in the constructor method -
		performance will be a lot better...
	</li>
	<li>
		Notice how the getDate() and getMoney() methods overload the return value
		of your business object contained in the List.  They use the
		<code>TableDecorator.getCurrentRowObject()</code> method to get a handle to the underlying
