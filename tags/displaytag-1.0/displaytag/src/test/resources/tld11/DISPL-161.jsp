  ...
  <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
      ...
      <display:table name="requestScope.test" id="table">
        ...
        <display:column nulls="false" title="empty"><jsp:expression>((org.displaytag.sample.ListObject)pageContext.getAttribute("table")).getNullValue()</jsp:expression></display:column>
