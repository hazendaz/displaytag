  ...
  <tags:page>
    ...
    <ol>
      <li>to demonstrate exports that mimic the HTML data presentation. What you see rendered in the Excel, PDF, and RTF
        formats is what you see rendered as HTML
      </li>
      <li>to demonstrate how easy it is to implement this by applying the template method pattern to render the main
        table and decorate it
      </li>
    </ol>
    <p>
      <strong>Why would one want to do this?</strong>
      When typical business users are presented with the displaytag export facility, they usually expect the exported
      Excel or PDF to look just like the HTML in their browser; they expect a WYSIWYG rendering. Yes, even when
    ...
    <p>
      ...
      You have a List who's objects are sorted and grouped by column A, column B and column C, so instead of repeating
